...
def make_html_line(coords = [-122.45, 37.79]):
  here = make_beg(coords)
  here2 = '''
  style:'mapbox://styles/mapbox/dark-v8'
,
  hash: false
...
def profile(x,y,z):
    ...
    return a.make_tile_lines(coords)
...
def make_html_polygon(coords=[-122.45, 37.79]):
  here = make_beg(coords)
  here2 = '''
  style:'mapbox://styles/mapbox/dark-v8'
,
...
def profile(x,y,z):
    ...
    return a.make_tile_polygons(coords)
